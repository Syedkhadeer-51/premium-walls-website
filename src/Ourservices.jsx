    ...
    <div className='main-container p-0 m-0' id='skilled-technician'>
      <div className='row p-3'>
        ...
        <div className='col-md-6 col-12 d-flex flex-column justify-content-center align-items-center  animate__animated animate__fadeInRight'>
          <div className='skilled-technician-title px-sm-5 px-3'>Skilled Home Services for Every Requirement</div>
          <div className='skilled-technician-description m-2 px-sm-5 px-2 py-3'>
